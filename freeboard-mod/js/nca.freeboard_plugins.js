...
(function () {
        ...
        newInstance: function (settings, newInstanceCallback)
 {
        ...
        function updatePosition() {
            for (icp = 0; icp < currentEntity.length; icp++) {
                if (map && currentEntity[icp].lat && currentEntity[icp].lon) {
                    //if (map && currentEntity[index].lat && currentEntity[index].lon) {
                    ...
                    '<b>Dernier ramasassage : </b>' + dateLastEmptyingformat + '</br>' + '</p>' +
                    '</div>'+
                    '</div>';
	...
	var selectMenuWidget = function (settings) {
	freeboard.loadWidgetPlugin({
		// Same stuff here as with datasource plugin.
		"type_name"   : "SelectMenu",
		"display_name": "Select Menu",
        "description" : "Les communes de la Metropole",
		"fill_size" : true,
		"settings"    : [
		...
		// Same as with datasource plugin, but there is no updateCallback parameter in this case.
			newInstance   : function(settings, newInstanceCallback)
		{
			newInstanceCallback(new selectMenuWidget(settings));
		}
	});
}());
